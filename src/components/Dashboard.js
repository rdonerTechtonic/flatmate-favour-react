...
export const Dashboard = ({ ffRoommates, ffEvents, handleUpdateEventStatus, handleDateChange, handleEditHouse, handleEventEdit, handleNewEvent, handleLogout }) => {
    return (
      <div>
        <Link to="/login"><img src="/Flatmate-Favour-Logo.png" alt="flatmate favour icon" id="logo" /></Link>
          <UserBar handleEditHouse={handleEditHouse} ffRoommates={ffRoommates} handleLogout={handleLogout}/>
